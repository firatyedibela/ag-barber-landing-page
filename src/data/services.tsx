...
export const services: Service[] = [
  {
    icon: '../src/assets/services/haircut.svg',
  ...
  {
    icon: '../src/assets/services/beard.svg',
  ...
  {
    icon: '../src/assets/services/hair-dryer.svg',
  ...
  {
    icon: '../src/assets/services/face.svg',
    title: 'Yüz Bakımı',
    description:
  ...
  {
    icon: '../src/assets/services/eyebrow.svg',
